...
export default {
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/amulets' },
  ...
  extraViews: [
    ...
    // results/gallery) is byte-identical to carpets' own on `origin/main`
    ...
    // `body` entry name).
    ...standardRoutes('gallery', { creditsBody: 'amulets.credits.body' }),
  ],
