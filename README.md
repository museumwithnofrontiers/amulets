...
The **Museum With No Frontiers — Amulets and Talismans** gallery, built from the published
dataset `@museumwnf/amulets-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/amulets-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/amulets/> through the reusable workflows in
